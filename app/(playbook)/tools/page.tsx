...
const groups: ToolGroup[] = [
  ...
  {
    theme: 'Prompt-to-UI & Design Generation', tab: 'Design', color: '#FF69DB',
    tools: [
  ...
  {
    theme: 'Vibe Coding & Design-to-Code', tab: 'Design', color: '#FB923C',
    tools: [
  ...
  {
    theme: 'Workflow Automation & Integrations', tab: 'Automate', color: '#E8C840',
    tools: [
  ...
  {
    theme: 'Browser Agents, UI Screening & QA', tab: 'Automate', color: '#FF6B6B',
    tools: [
