...
// Force server-render on every request — no static cache
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0A0010', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: 'clamp(80px,8vw,130px) clamp(20px,4vw,48px) clamp(60px,6vw,100px)' }}>
        ...
        {/* Divider */}
        <div className="section-divider animate-fade-up delay-250" style={{ marginBottom: 44 }} />

        {/* Section cards */}
        <div className="animate-fade-up delay-350" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(260px,1fr))', gap: 16 }}>
          {sections.map(card => {
