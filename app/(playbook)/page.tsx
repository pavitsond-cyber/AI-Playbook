...
const sections = [
  { num: '01', title: 'Skills',   sub: 'Senior-level shortcuts',                href: '/skills'   },
  { num: '02', title: 'Prompts',  sub: 'Starting points, not magic spells',      href: '/prompts'  },
  { num: '03', title: 'Glossary', sub: 'Buzzwords, translated and how they\'re used', href: '/glossary' },
  { num: '04', title: 'Tools',    sub: 'Our AI tool shelf',                       href: '/tools'    },
]
