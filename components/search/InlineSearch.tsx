    ...
    <div ref={wrapRef} style={{ position: 'relative', ...wrapperStyle }}>
      ...
      >
        ...
        {q ? (
          ...
          <kbd style={{
            fontSize: 19, padding: '2px 6px', borderRadius: 5,
        ...
        >
          ...
          {!hasQ && (
            <div style={{ padding: '14px 14px 16px' }}>
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        color: c.color, fontSize: 19, fontWeight: 500, cursor: 'pointer',
              ...
              <p style={{ fontSize: 19, color: 'rgba(255,255,255,0.2)', marginTop: 12, lineHeight: 1.5 }}>
          ...
          {hasQ && total === 0 && (
            <div style={{ padding: '28px 16px', textAlign: 'center' }}>
              <p style={{ fontSize: 19, color: 'rgba(255,255,255,0.7)', marginBottom: 4 }}>
                Nothing found for &ldquo;<strong>{q}</strong>&rdquo;
              </p>
              <p style={{ fontSize: 19, color: 'rgba(255,255,255,0.3)' }}>
            ...
            return (
              <div key={type} style={{ paddingBottom: 4 }}>
                ...
                <div style={{
                  ...
                  <span style={{
                    fontSize: 19, fontWeight: 600, padding: '1px 7px',
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{
                          ...
                          <span style={{ fontSize: 19, fontWeight: 500, color: 'rgba(255,255,255,0.9)', lineHeight: 1.3 }}>
                            <Hi text={item.title} q={q} />
                          </span>
                          {item.subtitle && (
                            <span style={{
                              fontSize: 19, color: 'rgba(255,255,255,0.3)',
                        ...
                        <p style={{
                          fontSize: 19, color: 'rgba(255,255,255,0.4)', lineHeight: 1.45, margin: 0,
                          overflow: 'hidden',
                          display: '-webkit-box',
                          WebkitLineClamp: 1,
          ...
          {hasQ && total > 0 && (
            <div style={{
              ...
              <span style={{ fontSize: 19, color: 'rgba(255,255,255,0.2)' }}>
                {total} result{total !== 1 ? 's' : ''}
              </span>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 19, color: 'rgba(255,255,255,0.2)' }}>
                <span>↑↓ move</span>
