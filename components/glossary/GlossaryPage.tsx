    ...
    <div style={{ position: 'relative', minHeight: '100vh', background: '#0A0010', overflow: 'hidden' }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 960, margin: "0 auto", width: "100%" }}>
        ...
        <div className="animate-fade-up delay-75" style={{ padding: "clamp(64px,6vw,100px) clamp(20px,4vw,48px) 20px" }}>
          ...
          <p className="mt-1" style={{ fontFamily: 'var(--font-body)', fontSize: 19, color: 'rgba(255,255,255,0.3)' }}>
                  ...
                  {abbrGroups.map(group => (
                    <div key={group.category} id={`abbr-group-${group.category}`}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                        ...
                        <span style={{ fontFamily: 'var(--font-body)', fontSize: 19, color: 'rgba(255,255,255,0.2)' }}>
                  ...
                  {ALPHABET.map(letter => {
                    ...
                    return (
                      <button
                        ...
                        disabled={!has}
                        style={{
                          width: 28, height: 26, fontSize: 19, fontWeight: 700,
