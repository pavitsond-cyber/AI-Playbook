    ...
    <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 64 }}>
      <div style={{ maxWidth: 768, margin: '0 auto', padding: '28px 20px', display: 'flex', flexDirection: 'column' as const, gap: 6, alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontFamily: 'var(--font-display)', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.4)', letterSpacing: '-0.01em' }}>AI Playbook</span>
        </div>
        <p style={{ fontFamily: 'var(--font-body)', fontSize: 22, color: 'rgba(255,255,255,0.2)', textAlign: 'center' }}>A practical AI reference · 2026</p>
      </div>
    </footer>
  )
}
